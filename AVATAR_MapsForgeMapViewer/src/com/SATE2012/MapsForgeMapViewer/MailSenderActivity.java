...
public class MailSenderActivity extends Activity
{
	...
	try
	{
	    ...
	    {
		 ptLat = ""+extrasBundle.getDouble("lat");
		 ptLng = ""+extrasBundle.getDouble("lon");
	    }
	    else 
	    {
	...
	{
	    Toast.makeText(getApplicationContext(), "Cannot find location or get the location coordinates from the MasForgeMapViewer class.", Toast.LENGTH_SHORT).show();
	}
