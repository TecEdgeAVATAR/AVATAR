	...
	public void onClick(View v)
	{
		...
		// case (R.id.uploadB):
			default:
				 ...
				 * Toast.LENGTH_LONG).show(); // Create/call intent to map
				 * activity here // Load the MapsForgeMapViewer
				 * Toast.makeText(getApplicationContext(),
				 * "MapViewer is not yet available.", Toast.LENGTH_LONG)
				 * .show(); break; case (R.id.naoB):
				 * Toast.makeText(getApplicationContext(),
				 * "Ashu couldn't get this to work.", Toast.LENGTH_LONG)
				 * .show(); // Create/call intent to nao activity here break;
				 * case (R.id.arB): Toast.makeText(getApplicationContext(),
				 ...
				 * , Toast.LENGTH_LONG).show(); // Create/call intent to
				 * settings activity here break; */
		}
	}
}
